...
public class PrimerFragment extends Fragment {
    ...
    TextView txtaciertos, txterrores, txtresultado;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtaciertos = getView().findViewById(R.id.lblaciertos);
        txterrores = getView().findViewById(R.id.lblfallos);
        txtresultado = getView().findViewById(R.id.lblcalificacion);

        super.onViewCreated(view, savedInstanceState);
    }

    public void mostrarResultados(int aciertos, int errores, int puntos){
        txtaciertos.setText("Aciertos" + aciertos);
        txterrores.setText("Errores" + errores);
        txtresultado.setText("Puntos: "+ puntos);
    }
}